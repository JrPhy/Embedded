...
![img](https://d1dwq032kyr03c.cloudfront.net/upload/images/20230911/20161828uLKMvytWK6.png)

在開機流程其實也跟 uboot 類似，當按下 reset 鍵後會先初始化 CPU，並由裡面的快取記憶體初始化記憶體跟顯示卡，然後就會跳到開機預設的記憶體區，對應到 uboot 的第一階段。第二階段就是跳轉到 OS，相當於跳轉到 main。相較於 uboot，UEFI 整體受到規範，所以開發起來也較 uboot 繁瑣。
